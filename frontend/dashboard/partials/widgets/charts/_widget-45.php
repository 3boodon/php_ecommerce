    ...
    <div class="card-header pt-5">
        ...
        <div class="card-toolbar">
            ...
            <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                <i class="ki-duotone ki-element-plus fs-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>            </button>
<!--begin::Menu 3-->
        ...
        <div class="m-0">
                ...
                <div class="d-flex flex-stack mb-9">
                    ...
                    <div class="d-flex align-items-center me-2">
                        ...
                        <div class="symbol symbol-50px me-5">
                            <div class="symbol-label bg-light">
                                <img src="assets/media/svg/brand-logos/telegram-2.svg" alt="" class="h-50" alt=""/>
                            </div>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Title-->
