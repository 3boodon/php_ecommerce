    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      ...
      ?>
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="./dashboard/index.php" class="nav-link " data-placement="bottom" data-toggle="popover" data-trigger="hover" data-content="<?php echo $_SESSION['email'] ?>"><i class="fa fa-user-circle "></i></a></li>
        </ul>
      <?php
      } else {
      ?>
